...
import { CardComponent } from "./CardComponent"; // Assuming this component exists

const locations = [
  {
    title: "Cultivate Design Thinking ",
    timings:
      "We provide a nurturing environment for members to develop their design thinking skills, from ideation to prototyping and testing.",
    address: "",
  },
  {
    title: "Promote Social Impact",
    timings:
      "Our projects aim to address pressing societal issues, leveraging design thinking to drive meaningful and sustainable change.",
    address: "",
  },
  {
    title: "Foster Community Engagement ",
    timings:
      " We actively collaborate with local organizations, businesses, and community members to create shared value and foster a spirit of collective problemsolving.",
    address: "",
  },
]

// Deduplicated and organized users array
const users = [
  {
      ...
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="flex flex-col space-y-8 pb-10 pt-12 md:pt-24">
          ...
          <p className="max-w-4xl text-base text-gray-600 md:text-xl">
            The Design Thinking Club is a vibrant community of innovators, problem-solvers, and visionaries who come
            together to apply design thinking principles to tackle real-world challenges. Through our collaborative
            approach, we strive to create positive change and empower our local community. or The Design Thinking Club
            is a dynamic hub for creative minds, problem-solvers, and future leaders. We unite to tackle real-world
            challenges using innovative design thinking. Together, we drive positive change and empower our community
            through collaboration and bold ideas.
          </p>
        </div>
        <div className="w-full space-y-4">
          <img className="h-[100px] w-full rounded-xl object-contain md:h-full" src={s2 || "/placeholder.svg"} alt="" />
        </div>
        ...
        <div className="mt-16 flex items-center">
          <div className="space-y-6 md:w-3/4">
            ...
            <p className="max-w-4xl text-base text-gray-700 md:text-xl">
              Our philosophy is simple—bring together a diverse group of creative thinkers and cultivate a collaborative
        ...
        <div className="flex flex-col items-center gap-x-4 gap-y-4 py-16 md:flex-row">
          <div className="space-y-6">
            ...
            <p className="text-base text-gray-600 md:text-lg">
              Discover the exciting world of computer science through our engaging workshop designed just for you! Dive
              into various domains such as Web Development, Artificial Intelligence ,Cybersecurity, and more. This is
              your chance to explore different fields, understand what sparks your interest, and find the path that best
              suits your passion and skills. Don't miss out on this opportunity to gain valuable insights and set the
              stage for your future career in tech!
            </p>
          ...
          <div className="md:mt-o mt-10 w-full object-contain">
            <img src={a2 || "/placeholder.svg"} alt="Getting Started" className="rounded-lg" />
          </div>
        </div>
      </div>
      <hr className="mt-6" />
